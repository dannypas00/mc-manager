        ...
        <div class="flex h-16 items-center justify-between">
          ...
          <div class="hidden md:block">
            <div class="ml-4 flex items-center md:ml-6">
              ...
              >
                ...
                <span class="sr-only" v-t="'components.layout.view_notifications'"/>
              ...
              <Menu as="div" class="relative ml-3">
                <div>
                  <MenuButton class="relative flex max-w-xs items-center rounded-full bg-brand text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-brand">
                    <span class="absolute -inset-1.5"/>
                    <span class="sr-only" v-t="'components.layout.open_user_menu'"/>
          ...
          <div class="-mr-2 flex md:hidden">
            ...
            <DisclosureButton class="relative inline-flex items-center justify-center rounded-md bg-brand p-2 text-brand-light hover:bg-brand-hover hover:bg-opacity-75 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-brand">
              ...
              <span class="sr-only" v-t="'components.layout.open_main_menu'"/>
      ...
      <DisclosurePanel class="md:hidden">
        ...
        <div class="border-t border-brand-dark pb-3 pt-4">
          ...
          <div class="mt-3 space-y-1 px-2">
            <StackedDisclosureNavEntry v-for="item in userNavigation" :item="item"/>
          </div>
        </div>
      </DisclosurePanel>
    </Disclosure>
